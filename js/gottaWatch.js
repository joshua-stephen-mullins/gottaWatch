                ...
                .then((list) => {
                    ...
                    list.content.forEach((content) => {
                        fetch(`https://api.themoviedb.org/3/${content.type}/${content.id}?api_key=${apiKeyTMDP}&language=en-US`)
                            ...
                            <img src="https://image.tmdb.org/t/p/original/${data.poster_path}" class="m-1" alt="Movie Poster" id="listContent_${content.id}" style="height: 10em" data-bs-toggle="modal" data-bs-target="#moreInfoModal" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="${data.title}">
                            `)
                                    } else {
                                        $(`#listModalMovies`).append(`
                            <img src="https://image.tmdb.org/t/p/original/${data.poster_path}" class="m-1" alt="Movie Poster" id="listContent_${content.id}" style="height: 10em" data-bs-toggle="modal" data-bs-target="#moreInfoModal" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="${data.name}">
                            `)
                                    }
